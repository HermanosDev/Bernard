...
public class UtilMath
{
    ...
    public static String ArrayToString(final String[] list) {
        ...
        for (final String key : list) {
            string = String.valueOf(String.valueOf(string)) + key + ",";
        }
        if (string.length() != 0) {
    ...
    public static String decrypt(final String strEncrypted) {
        ...
        try {
            ...
            strData = String.valueOf(new String(decoded, "UTF-8")) + "\n";
        }
        catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static String serializeLocation(final Location location) {
        ...
        return new String(String.valueOf(String.valueOf(location.getWorld().getName())) + "," + X + "," + Y + "," + Z + "," + P + "," + Yaw);
    }
